...
@Injectable()
export class ClinicDetailsServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<ClinicDetailsDto> {
        let url_ = this.baseUrl + "/api/services/app/ClinicDetails/Get?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ClinicDetailsDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ClinicDetailsDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<ClinicDetailsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ClinicDetailsDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ClinicDetailsDto>(null as any);
    }
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ClinicDetailsDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/ClinicDetails/GetAll?";
        if (keyword === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ClinicDetailsDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ClinicDetailsDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ClinicDetailsDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ClinicDetailsDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ClinicDetailsDtoPagedResultDto>(null as any);
    }
     ...
     * @return Success
     */
    create(body: ClinicDetailsDto | undefined): Observable<ClinicDetailsDto> {
        let url_ = this.baseUrl + "/api/services/app/ClinicDetails/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<ClinicDetailsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: ClinicDetailsDto | undefined): Observable<ClinicDetailsDto> {
        let url_ = this.baseUrl + "/api/services/app/ClinicDetails/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<ClinicDetailsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/ClinicDetails/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class ClinicDetailsDto implements IClinicDetailsDto {
    id: number;
    ...
    constructor(data?: IClinicDetailsDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ClinicDetailsDto {
        data = typeof data === 'object' ? data : {};
        let result = new ClinicDetailsDto();
        result.init(data);
        return result;
    }
...
export interface IClinicDetailsDto {
    id: number;
    name: string | undefined;
    address: string | undefined;
    email: string | undefined;
...
export class ClinicDetailsDtoPagedResultDto implements IClinicDetailsDtoPagedResultDto {
    items: ClinicDetailsDto[] | undefined;
    totalCount: number;

    constructor(data?: IClinicDetailsDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(ClinicDetailsDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): ClinicDetailsDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ClinicDetailsDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ClinicDetailsDtoPagedResultDto {
        const json = this.toJSON();
        let result = new ClinicDetailsDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IClinicDetailsDtoPagedResultDto {
    items: ClinicDetailsDto[] | undefined;
    totalCount: number;
}
